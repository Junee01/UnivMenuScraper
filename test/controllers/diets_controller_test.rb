...
class DietsControllerTest < ActionController::TestCase
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post :create, diet: { date: @diet.date, diet: @diet.diet, extra: @diet.extra, location: @diet.location, name: @diet.name, time: @diet.time, univ_id: @diet.univ_id }
    end
  ...
  test "should update diet" do
    patch :update, id: @diet, diet: { date: @diet.date, diet: @diet.diet, extra: @diet.extra, location: @diet.location, name: @diet.name, time: @diet.time, univ_id: @diet.univ_id }
    assert_redirected_to diet_path(assigns(:diet))
  end
